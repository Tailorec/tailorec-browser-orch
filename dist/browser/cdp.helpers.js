...
const ws_js_1 = require("../infra/ws.js");
const extension_relay_js_1 = require("./extension-relay.js");
...
function getHeadersWithAuth(url, headers = {}) {
    const relayHeaders = (0, extension_relay_js_1.getChromeExtensionRelayAuthHeaders)(url);
...
function createCdpSender(ws) {
    ...
    ws.on("message", (data) => {
        try {
            const parsed = JSON.parse((0, ws_js_1.rawDataToString)(data));
