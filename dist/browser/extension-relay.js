...
async function ensureChromeExtensionRelayServer(opts) {
    ...
    const relayAuthToken = (0, node_crypto_1.randomBytes)(32).toString("base64url");
    ...
    const wssExtension = new ws_1.WebSocketServer({ noServer: true });
    const wssCdp = new ws_1.WebSocketServer({ noServer: true });
